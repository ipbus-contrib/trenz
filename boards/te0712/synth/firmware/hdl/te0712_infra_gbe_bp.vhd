...
entity te0712_infra is
    ...
    port(
        ...
        -- All signals prefixed with bp_eth_ are inputs to, or outputs from MGT1.
        -- This MGT connects to backplane GbE connection IPBus.
        eth_bp_rx_p   : in std_logic; -- Ethernet MGT input
        eth_bp_rx_n   : in std_logic;
        eth_bp_tx_p   : out std_logic; -- Ethernet MGT output
...
architecture rtl of te0712_infra is
	...
	signal clk125_fr, clk125, clk_ipb, clk_ipb_i, locked, clk_locked, eth_locked, eth_bp_locked, rst125, rst_125_bp, rst_ipb, rst_ipb_ctrl, rst_eth, onehz, pkt: std_logic;
    ...
    signal clk_indep, user_clk, gtrefclk_out : std_logic;
    signal pma_reset : std_logic;
    signal gt0_pll0outclk_in, gt0_pll0outrefclk_in, gt0_pll1outclk_in, gt0_pll1outrefclk_in, gt0_pll0lock_in, gt0_pll0refclklost_in : std_logic; 
...
--------------------------------------------------------------------------------
--  Backplane GbE + IPBus core.
bp_eth_ipbus: entity work.mib_bp_ipbus
    port map(
        ipb_clk         => clk_ipb,
        rst_125         => rst_125_bp,
        eth_bp_rx_p     => eth_bp_rx_p,
        eth_bp_rx_n     => eth_bp_rx_n,
        eth_bp_tx_p     => eth_bp_tx_p,
        eth_bp_tx_n     => eth_bp_tx_n,
        clk125          => clk125,
        clk125_fr       => clk125_fr,
        rst_eth         => rst_eth,
